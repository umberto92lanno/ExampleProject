...
Nel nostro caso la prima schermata che verrà visualizzata sarà App
(è possibile trovare riferimenti alla schermata dalla riga: "import App from './src/AppReal';")
